...
function generateRandomCompliment() {
    const sentences = vscode.workspace.getConfiguration('cmakeLastSuccessfulCompilation').get('compliments') || ["Awesome", "Fantastic", "Incredible", "Remarkable", "Extraordinary"];
